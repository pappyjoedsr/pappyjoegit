...
namespace PappyjoeMVC.Controller
{
    ...
    {
        Appointment_for_each_patient_group_interface intr;
        Appointment_report_model _model = new Appointment_report_model();
        common_model model = new common_model();
        public Appointment_for_each_patient_group_controller(Appointment_for_each_patient_group_interface inttr)
        {
            intr = inttr;
