...
namespace PappyjoeMVC.Model
{
    public class Reports_model
    {
        ...
        {
            DataTable dt = db.table("select b.Item_Code, i.item_name, b.PurchNumber, b.PurchDate, b.BatchNumber, b.Qty, b.ExpDate, (select s.Supplier_Name from tbl_Supplier S where S.Supplier_Code = b.Sup_Code) Supplier_Name from tbl_BatchNumber b left join tbl_ITEMS i on i.id = b.Item_Code  where b.IsExpDate = 'Yes' and b.ExpDate between '" + dateFrom + "' and '" + dateTo + "'");
            return dt;
        }
    }
}
