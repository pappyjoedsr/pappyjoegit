        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridViewmonthlyappoinment.Rows.Count > 0)
                {
                    ...
                    {
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<th colspan=11><center><b><FONT COLOR=black FACE='Segoe UI'  SIZE=3> MONTHLY APPOINTMENT " + "  </font></center></b></td>");
                        sWrite.WriteLine("</tr>");
                    }
                    else if (Cmb_Doctor.SelectedIndex != 0)
                    {
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<th colspan=11><center><b><FONT COLOR=black FACE='Segoe UI'  SIZE=3> MONTHLY APPOINTMENT (" + Cmb_Doctor.Text.ToUpper() + " ) </font></center></b></td>");
                        sWrite.WriteLine("</tr>");
                    }
                    sWrite.WriteLine("<table align='center' style='width:700px;border: 1px ;border-collapse: collapse;'>");
                    sWrite.WriteLine("<tr>");
                    ...
                    if (dataGridViewmonthlyappoinment.Rows.Count > 0)
                    {
                        ...
                        sWrite.WriteLine("    <td align='left' width='80' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI'  SIZE=2><b>Patient Id</b></font></td>");
