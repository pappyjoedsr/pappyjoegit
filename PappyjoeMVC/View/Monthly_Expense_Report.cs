        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                if (Dgv_Expense.Rows.Count > 0)
                {
                    ...
                    sWrite.WriteLine("<tr>");
                    sWrite.WriteLine("<th colspan=8> <center><FONT COLOR=black FACE='Segoe UI' SIZE=4>  <b> MONTHLY EXPENSE REPORT </b> </font></center></th>");
                    sWrite.WriteLine("</tr>");
                    sWrite.WriteLine("<tr>");
                    ...
                    {
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("    <td align='center' width='6%' style='border:1px solid #000;background-color:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3 >Sl.</font></th>");
                        sWrite.WriteLine("    <td align='center' width='12%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Date</font></th>");
                        sWrite.WriteLine("    <td align='center' width='16%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Transaction Type</font></th>");
                        sWrite.WriteLine("    <td align='center' width='16%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Ledger</font></th>");
                        sWrite.WriteLine("    <td align='center' width='16%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Account Name</font></th>");
                        if (Chk_Type.Checked)
                        {
                            if (rad_Expanse.Checked)
                            {
                                sWrite.WriteLine("    <td align='center' width='20%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Amount (Cr)</font></th>");
                            }
                            else if (rad_Income.Checked)
                            {
                                sWrite.WriteLine("    <td align='center' width='20%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Amount(Dr)</font></th>");
                            }
                            else
                            {
                                sWrite.WriteLine("    <td align='center' width='20%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Amount (Cr)</font></th>");
                        ...
                        sWrite.WriteLine("    <td align='center' width='20%' style='border:1px solid #000;background:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> Description</font></th>");
                        sWrite.WriteLine("</tr>");
                        int k = 1;
                        for (int i = 0; i < Dgv_Expense.Rows.Count; i++)
                        {
                            ...
                            sWrite.WriteLine("    <td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["ColDate"].Value.ToString() + "</font></th>");
                            sWrite.WriteLine("    <td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["colTransType"].Value.ToString() + "</font></th>");
                            sWrite.WriteLine("    <td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["colLedger"].Value.ToString() + "</font></th>");
                            sWrite.WriteLine("    <td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["ColAccountName"].Value.ToString() + "</font></th>");
                            if (Chk_Type.Checked)
                            {
                                if (rad_Expanse.Checked)
                                {
                                    sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["CoAmountCr"].Value.ToString() + "</font></th>");
                                }
                                else if (rad_Income.Checked)
                                {
                                    sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["colAmountdr"].Value.ToString() + "</font></th>");
                                }
                                else
                                {
                                    sWrite.WriteLine("    <td align='right' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["CoAmountCr"].Value.ToString() + "</font></th>");
                            ...
                            sWrite.WriteLine("    <td align='left' style='border:1px solid #000' ><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + Dgv_Expense.Rows[i].Cells["ColDescription"].Value.ToString() + "</font></th>");
                            k = k + 1;
                            sWrite.WriteLine("</tr>");
                        }
                        sWrite.WriteLine("</td>");
