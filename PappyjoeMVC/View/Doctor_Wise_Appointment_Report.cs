        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridVieweachdoctorappoinmt.Rows.Count > 0)
                {
                    ...
                    {
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<th colspan=11><center><b><FONT COLOR=black FACE='Segoe UI'  SIZE=3> DOCTOR WISE APPOINTMENT REPORT(All Doctor) </font></center></b></td>");
                        sWrite.WriteLine("</tr>");
                    }
                    if (comboBoxdoctor.SelectedIndex != 0)
                    {
                        sWrite.WriteLine("<tr>");
                        sWrite.WriteLine("<th colspan=11><center><b><FONT COLOR=black FACE='Segoe UI'  SIZE=3> APPOINTMENT REPORT OF DR." + comboBoxdoctor.Text.ToUpper() + " </font></center></b></td>");
                        sWrite.WriteLine("</tr>");
                    }
                    sWrite.WriteLine("<table align='center' style='width:700px;border: 1px ;border-collapse: collapse;'>");
                    sWrite.WriteLine("<tr>");
                    ...
                    if (dataGridVieweachdoctorappoinmt.Rows.Count > 0)
                    {
                        ...
                        sWrite.WriteLine("    <td align='left' width='30%' style='border:1px solid #000;background-color:#999999'><FONT COLOR=black FACE='Segoe UI' SIZE=3> <b>&nbsp;Patient Id</b> </font></td>");
