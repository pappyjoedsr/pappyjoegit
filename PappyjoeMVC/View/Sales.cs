...
namespace PappyjoeMVC.View
{
    public partial class Sales : Form
    {
        ...
        public static bool batch_flag = false;
        public static string invnum_order;
        public Sales()
        {
            InitializeComponent();
        }
        ...
        public void printhtml()
        {
            try
            {
                ...
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<th colspan=8><center><br><br><FONT COLOR=black FACE='Segoe UI'  SIZE=3> SALES INVOICE </font></center></td>");
                sWrite.WriteLine("</tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td  colspan=8 align='left'><FONT COLOR=black FACE='Segoe UI'  SIZE=3>  <b> " + strclinicname + "</b> </font></left></td>");
                sWrite.WriteLine(" </tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td colspan=8 align='left'><FONT COLOR=black FACE='Segoe UI' SIZE=1><b>" + strphone + " </b> </font></left></td>");
                sWrite.WriteLine(" </tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td colspan=8 align='left'><FONT COLOR=black FACE='Segoe UI' SIZE=1><b>" + DlNumber + "</b> </font></left></td>");
                sWrite.WriteLine(" </tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td colspan=8 align='left'><FONT COLOR=black FACE='Segoe UI'  SIZE=1><b>" + DlNumber2 + "</b> </font></left></td>");
                sWrite.WriteLine(" </tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td colspan=8 align='left'><FONT COLOR=black FACE='Segoe UI'   SIZE=1><b>" + website + " </b> </font></left></td>");
                sWrite.WriteLine(" </tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td colspan=7 align='left'><FONT COLOR=black FACE='Segoe UI' SIZE=2>" + str_druglicenseno + "</font></left></td>");
                sWrite.WriteLine("<td colspan=7 align='right'><FONT COLOR=black FACE='Segoe UI'   SIZE=2>" + str_taxno + " </font></right></td>");
                sWrite.WriteLine("</tr>");
                sWrite.WriteLine("<tr>");
                ...
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td align='left'  width='62'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Sl.</font></td>");
                sWrite.WriteLine("<td align='left'  width='128'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Item Code</font></td>");
                sWrite.WriteLine("<td align='left'  width='190'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Description</font></td>");
                sWrite.WriteLine("<td align='right'  width='153'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Batch/Expiry</font></td>");
                sWrite.WriteLine("<td align='right'  width='61' ><FONT COLOR=black FACE='Segoe UI' SIZE=3>Unit</font></td>");
                sWrite.WriteLine("<td align='right'  width='70'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Quantity</font></td>");
                sWrite.WriteLine("<td align='right'  width='93'><FONT COLOR=black FACE='Segoe UI' SIZE=3>Cost</font></td>");
                sWrite.WriteLine("<td align='right'  width='107'><FONT COLOR=black FACE='Segoe UI' SIZE=3>TotalAmount</font></td>");
                sWrite.WriteLine("</tr>");
                ...
                sWrite.WriteLine("<tr><td align='left'  colspan=8><hr/></td></tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' SIZE=2> Total Items :</font></td>");
                sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=3> &nbsp " + txt_totalItems.Text + " </font></td>");
                sWrite.WriteLine("</tr>");
                if (txt_CGST.Text != "")
                {
                    sWrite.WriteLine("<tr>");
                    sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' SIZE=2> CGST :</font></td>");
                    sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=3>&nbsp" + txt_CGST.Text + " </font></td>");
                    sWrite.WriteLine("</tr>");
                    sWrite.WriteLine("<tr>");
                    sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' SIZE=2> SGST :  </font></td>");
                    sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=3>&nbsp " + txt_SGST.Text + " </font></td>");
                    sWrite.WriteLine("</tr>");
                }
                ...
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' SIZE=2>Total Amount :  </font></td>");
                sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=2>&nbsp" + String.Format("{0:C}", decimal.Parse(Txt_TotalAmount.Text)) + " </font></td>");
                sWrite.WriteLine("</tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' SIZE=2>Discount :</font></td>");
                sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=2>&nbsp" + txt_Discount.Text + " </font></td>");
                sWrite.WriteLine("</tr>");
                sWrite.WriteLine("<tr>");
                sWrite.WriteLine("<td align='right'  colspan=7 ><FONT COLOR=black FACE='Segoe UI' 2>Grand Total : </font></td>");
                sWrite.WriteLine("<td align='right'  colspan=8 ><FONT COLOR=black FACE='Segoe UI' SIZE=2>&nbsp " + String.Format("{0:C}", decimal.Parse(txt_GrandTotal.Text)) + " </font></td>");
                sWrite.WriteLine("</tr>");
                sWrite.WriteLine("<tr><td align='left' colspan=8 > <FONT COLOR=black FACE='Segoe UI' SIZE=2>Pharmacist Signature</font></td></tr>");
                sWrite.WriteLine("<tr><td align='left'  colspan=8><hr/></td></tr>");
                sWrite.WriteLine("<tr><td align='left' colspan=8 > <FONT COLOR=black FACE='Segoe UI' SIZE=1><i>Goods once sold cannot be taken back or exchanged</i></font></td></tr>");
                sWrite.WriteLine("<tr><td align='left' colspan=8 > <FONT COLOR=black FACE='Segoe UI' SIZE=2>E&OE</font></td></tr>");
