...
{
    public partial class prescriptionShow : Form,prescriptionshow_interface
    { 
        ...
        prescriptionshow_controller cntrl;
        ...
        {
            var form2 = new PrescriptionAdd();
            form2.doctor_id = doctor_id;
            form2.patient_id = patient_id;
            PrescriptionAdd_controller controller = new PrescriptionAdd_controller(form2);
        ...
        public void SetController(prescriptionshow_controller controller)
        {
            cntrl = controller;
        }
