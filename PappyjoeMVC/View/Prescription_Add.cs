...
{
    public partial class Prescription_Add : Form,prescriptionAdd_interface
    {
        PrescriptionAdd_controller cntrl;
        ...
        public void SetController(PrescriptionAdd_controller controller)
        {
            cntrl = controller;
        }
