...
{
    public partial class Daily_treatment_count : Form, Daily_treatment_count_interface
    {
        Daily_treatment_count_controller cntrl;
        ...
        public void setcontroller(Daily_treatment_count_controller controller)
        {
            cntrl = controller;
        }
