...
namespace PappyjoeMVC.View
{
    public partial class Paymode_Wise_Receipt : Form
    {
        ...
        public string doctor_id = "", totlcost = "", totlincome = "", service = "", qty = "", doctr, mode, checkStr = "0", PathName = "", strclinicname = "", clinicn = "", strStreet = "", stremail = "", strwebsite = "", strphone = "",logo_name="";
        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                if (Dgv_Receipt.Rows.Count > 0)
                {
                    ...
                    {
                        sWrite.WriteLine("<table align='center' style='width:1000px;border: 1px ;border-collapse: collapse;'>");
                        sWrite.WriteLine("<tr>");
                    ...
                    sWrite.WriteLine("</table>");
                    sWrite.WriteLine("<tr>");
                    sWrite.WriteLine("<th colspan=11><center><b><FONT COLOR=black FACE='Segoe UI'  SIZE=3>PAY-MODE WISE  RECEIPT </font></center></b></td>");
                    sWrite.WriteLine("</tr>");
                    sWrite.WriteLine("<table align='center' style='width:700px;border: 1px ;border-collapse: collapse;'>");
                    sWrite.WriteLine("<tr>");
